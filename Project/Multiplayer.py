...
class gameRequestWindow():
    ...
    def acceptRequest(self,socket):
        ...
        if self.list3.curselection() != ():
            ...
            ##Change sprites of players to distinguish between them
            player1.walkRight = [pygame.image.load('GAME SPRITE/Edited/char 1/Run1.png'),
            pygame.image.load('GAME SPRITE/Edited/char 1/Run2.png'),
            pygame.image.load('GAME SPRITE/Edited/char 1/Run3.png'),
            pygame.image.load('GAME SPRITE/Edited/char 1/Run4.png'),
            pygame.image.load('GAME SPRITE/Edited/char 1/Run5.png'),
            ...
            player1.standingRight = pygame.image.load('GAME SPRITE/Edited/char 1/StandingRight.png')
            player1.standingLeft = pygame.image.load('GAME SPRITE/Edited/char 1/StandingLeft.png')

            player2.walkRight = [pygame.image.load('character/run1.png'),
            pygame.image.load('character/run2.png'),
            pygame.image.load('character/run3.png'),
            pygame.image.load('character/run4.png'),
            pygame.image.load('character/run5.png'),
            pygame.image.load('character/run6.png')]
            player2.walkLeft = [pygame.transform.flip(x, True, False) for x \
            in player2.walkRight]
            player2.standingRight = pygame.image.load('character/standingRight.png')
            player2.standingLeft = pygame.image.load('character/standingLeft.png')
